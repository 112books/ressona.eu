---
title: "Com protegir i registrar l'obra artística"
description: "Copyright automàtic, Registro de la Propiedad Intelectual, SGAE, SafeCreative, timestamps digitals. Com demostrar l'autoria de la teva obra i protegir-la davant de possibles conflictes."
translationKey: "blog-protecting-registering-artwork"
date: 2026-07-05
tags: ["copyright", "propietat-intel-lectual", "legal", "registre"]
category: legal
---
...
L'**[Oficina de Depòsit Legal i Registre de la Propietat Intel·lectual](https://www.culturaydeporte.gob.es/cultura/propiedadintelectual/registro-de-la-propiedad-intelectual.html)** (gestionada a Espanya a través de les comunitats autònomes) permet registrar obres i fer constar públicament la data de creació i l'autoria.

A Catalunya, el registre es fa a través del **[Departament de Cultura de la Generalitat](https://cultura.gencat.cat/ca/departament/estructura_i_adreces/organismes/sgdpcb/)**.
...
**[SafeCreative](https://www.safecreative.org/)** és un registre privat de propietat intel·lectual fundat a Espanya que permet registrar obres digitalment de manera ràpida i assequible. Genera un certificat amb timestamp criptogràfic i hash de l'arxiu que demostra que en una data determinada existia l'obra en aquell format.
...
Per a músics i compositors, **inscriure les obres a la [SGAE](https://www.sgae.es/)** (o a entitats com **[DAMA](https://www.dam-a.es/)** per a obres audiovisuals) és fonamental per a la recaptació de drets. No és exactament un registre de propietat intel·lectual — és un mecanisme de gestió col·lectiva dels drets — però té un efecte pràctic similar: les obres inscrites a la SGAE consten en un registre públic amb data i autoria.

Equivalent per a fotògrafs: **[Visual Entidad de Gestión de Artistas Plásticos (VEGAP)](https://vegap.es/)**.

Per a autors de llibres: **[CEDRO](https://www.cedro.org/)**.
...
**Vegeu també:**
- [Copyright d'imatges: de qui és i quan la puc usar](/recursos/copyright-imatges-quan-puc-usar/)
- [Drets d'imatge en vídeo](/recursos/drets-imatge-video/)
- [Contractes bàsics que tot músic ha de conèixer](/recursos/contractes-basics-musics/)

Ressona acompanya artistes a construir una presència digital professional que comunica autoria i professionalitat des del primer contacte. [Parla amb nosaltres](/#contacte).
