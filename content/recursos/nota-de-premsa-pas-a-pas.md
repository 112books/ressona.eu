---
title: "Nota de premsa per a artistes: com escriure-la pas a pas"
description: "Una nota de premsa no és un correu llarg. Té una estructura concreta, ocupa una pàgina i respon cinc preguntes en ordre. Guia pràctica amb plantilla inclosa."
...
Si vols entendre primer per què la nota de premsa és diferent de l'EPK i quan s'envia cada document, llegeix primer [Nota de premsa vs. EPK: quina diferència hi ha?](/recursos/nota-de-premsa-vs-epk/).
...
**Titular de cartell** (no serveix per a premsa):
«MARC PUIG — DEBUT — TARDOR 2026»

**Titular periodístic** (serveix):
«El saxofonista Marc Puig publica el seu primer disc en solitari amb cinc músics europeus»
...
Per entendre com gestionar les llicències de les teves imatges de premsa, llegeix [Fotos de premsa per a artistes](/recursos/fotos-de-premsa/).
...
La nota de premsa és un dels materials bàsics del teu press kit professional. Si encara no tens l'EPK muntat, llegeix [Nota de premsa vs. EPK: quina diferència hi ha?](/recursos/nota-de-premsa-vs-epk/) per entendre com s'organitza l'estratègia de comunicació completa.

Ressona treballa amb artistes per preparar materials de comunicació professional: nota de premsa, EPK, fotos de premsa, bio i estratègia d'enviament. Si vols que t'acompanyem en aquest procés, [explica'ns el teu projecte](/#contacte).
