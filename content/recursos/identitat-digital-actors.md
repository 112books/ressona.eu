...
## On et busquen els professionals del sector

Els professionals que poden contractar-te utilitzen eines molt específiques. Abans de construir res, cal saber on miren.
...
### Google amb el teu nom

El primer que fa qualsevol director o productora quan el teu nom els arriba per recomanació és buscar-te a Google. Si el resultat és un Instagram personal, un LinkedIn desactualitzat o res, la impressió és de poca professionalitat. El teu web propi i el teu press kit digital han d'aparèixer als primers resultats.
...
### Recomanacions directes entre professionals

Al teatre i al cinema independent, la majoria dels projectes s'articulen per xarxes de confiança. El teu nom arriba perquè un director et recomana a un altre, perquè el cap de producció et recorda d'un altre projecte, perquè la teva representació et proposa. La identitat digital no substitueix la xarxa, però és el que valida la recomanació quan el nou contacte et busca.

</div>

</div>

## Tres eines que necessites tenir construïdes
...
## La diferència entre el perfil de càsting i el press kit

Un perfil de plataforma de càsting (Casting.es, Mandy, LatinCast) té un format fix: foto, mides, habilitats, historial. Funciona per als processos de selecció gestionats per casting directors. Però té limitacions clares:
...
- **Cant**: si tens formació, especifica el registre (baríton, mezzosoprano) i el nivell (amateur, professional).
- **Carnet de conduir** i vehicles: rellevant per a rodatges en localitzacions.
- **Instruments musicals**: amb nivell real.

Exagerar genera problemes en els rodatges i destrueix la confiança dels directors. Ser precís genera credibilitat.
