---
title: "Drets d'imatge en vídeo: el que cal saber abans de gravar"
description: "Autoritzacions, RGPD, espai públic vs privat, ús comercial vs editorial. Tot el que necessites saber sobre drets d'imatge quan graves vídeo per a projectes artístics o de comunicació."
translationKey: "blog-image-rights-video"
date: 2026-07-05
tags: ["drets-imatge", "video", "legal", "rgpd"]
category: legal
---
...
1. **Drets teus com a artista**: els tens, pots usar el vídeo.
2. **Drets dels músics que apareixen**: si tens altres músics a l'escenari, necessites la seva autorització per a l'ús comercial del vídeo (el que publiques a xarxes per a promoure't és "ús comercial" en sentit ampli).
3. **Drets del públic**: si el vídeo capta clarament persones del públic, els mateixos criteris anteriors s'apliquen.
...
Si el teu vídeo inclou imatges de tercers (arxiu, stock, captures de vídeos d'altri), s'apliquen les regles de copyright d'imatge que tractem a l'article [Copyright d'imatges: de qui és i quan la puc usar](/recursos/copyright-imatges-quan-puc-usar/).
...
- [Drets d'autor i propietat intel·lectual per a artistes](/recursos/registrar-protegir-obra-artistica/)

Ressona treballa amb LinuxBCN per a la creació de vídeos professionals per a artistes i amb Pocallum per a fotografia i identitat visual. [Parla amb nosaltres](/#contacte).
