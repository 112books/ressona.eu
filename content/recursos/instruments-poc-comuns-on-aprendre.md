---
title: "Instruments poc comuns: on aprendre viola da gamba, theremin, oud i altres"
description: "Carrillons, viola da gamba, clavicèmbal, theremin, oud, sitar, instruments de canya exòtics. On trobar professors, escoles i festivals per a instruments fora dels circuits habituals."
translationKey: "blog-unusual-instruments-where-to-learn"
date: 2026-07-03
tags: ["formacio", "instruments", "musica-antiga", "instruments-poc-comuns"]
category: formacio
---
...
- **En línia**: **[Lessonface](https://www.lessonface.com/)** té professors de oud de diverses tradicions (àrab, turca, persa). El canal **[Arab Instruments](https://www.youtube.com/@ArabInstruments)** a YouTube té material introductori útil per a principiants.
- **Festivals**: el festival **[Músiques del Món](https://www.auditori.cat/)** a l'Auditori de Barcelona porta habitualment mestres d'oud i és un bon punt de contacte amb la comunitat local.
...
- **On aprendre**: l'escola de referència mundial és el **[Royal Carillon School "Jef Denyn" a Mechelen](https://www.beiaardschool.be/)** (Bèlgica), amb cursos d'estiu i formació de carrilloneur professional.
- **Xarxa**: la **[World Carillon Federation](https://www.worldcarillonfederation.org/)** agrupa escoles i intèrprets de tot el món i té un directori de professors i instruments.
...
- **En línia**: **[Sitar Academy Online](https://sitaracademy.com/)** — cursos estructurats en anglès amb professors de tradició. Les gravacions de **Nikhil Banerjee** i **Ravi Shankar** són les referències inevitables.
...
Quan no hi ha escola: **[Lessonface](https://www.lessonface.com/)**, **[TakeLessons](https://takelessons.com/)** i la xarxa personal de l'instrument (societats, federacions, festivals específics). La comunitat d'un instrument poc comú és petita però molt accessible — un email a la societat corresponent gairebé sempre genera resposta. Els professors d'instruments rars solen ser molt receptius amb els nous aprenents perquè la continuïtat de la tradició els importa.
...
- [Mestres de referència per instrument](/recursos/mestres-referencia-per-instrument/)

Ressona acompanya músics de qualsevol disciplina i tradició a construir la presència digital que els fa visibles als circuits professionals. [Parla amb nosaltres](/#contacte).
