...
Les dades personals que ens faciliteu a través del formulari de contacte o correu electrònic s'utilitzen exclusivament per respondre a la vostra consulta. La base legal del tractament és l'interès legítim del responsable per atendre les sol·licituds rebudes (art. 6.1.f RGPD).

Si us subscriviu al butlletí de notícies, les vostres dades (nom i correu electrònic) s'utilitzen per enviar-vos comunicacions periòdiques. La base legal és el vostre consentiment exprés (art. 6.1.a RGPD). Podeu revocar-lo en qualsevol moment mitjançant l'enllaç de baixa de cada correu.

**Destinataris i encarregats del tractament**

No cedirem les vostres dades a tercers sense el vostre consentiment exprés, excepte quan hi hagi una obligació legal. Aquest lloc web utilitza els serveis de tercers següents, que actuen com a encarregats del tractament:
...
Conservarem les vostres dades durant el temps necessari per atendre la vostra sol·licitud i, posteriorment, durant els terminis legals establerts. Les dades de subscriptors al butlletí es conserven fins que es revoca el consentiment.
