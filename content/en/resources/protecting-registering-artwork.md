---
title: "How to protect and register your artistic work"
description: "Automatic copyright, Spain's Intellectual Property Register, SGAE, SafeCreative, digital timestamps. How to prove authorship of your work and protect it against potential disputes."
translationKey: "blog-protecting-registering-artwork"
date: 2026-07-05
tags: ["copyright", "intellectual-property", "legal", "registration"]
category: legal
---
...
In Catalonia, registration is done through the **[Department of Culture of the Generalitat](https://cultura.gencat.cat/)**.
...
**[SafeCreative](https://www.safecreative.org/)** is a private intellectual property registry founded in Spain that allows digital registration of works quickly and affordably. It generates a certificate with a cryptographic timestamp and file hash that proves that at a given date, the work existed in that format.
...
For musicians and composers, **registering works with [SGAE](https://www.sgae.es/)** (or with entities like **[DAMA](https://www.dam-a.es/)** for audiovisual works) is fundamental for rights collection. It's not exactly an intellectual property register — it's a collective rights management mechanism — but it has a similar practical effect: works registered with SGAE appear in a public register with date and authorship.

Equivalent for photographers: **[VEGAP](https://vegap.es/)**.
For book authors: **[CEDRO](https://www.cedro.org/)**.
...
**See also:**
- [Image copyright: who owns it and when can I use it](/en/resources/image-copyright-when-to-use/)
- [Image rights in video](/en/resources/image-rights-video/)
- [Basic contracts every musician should know](/en/resources/basic-contracts-musicians/)

Ressona supports artists in building a professional digital presence that communicates authorship and professionalism from the first contact. [Get in touch](/en/#contacte).
